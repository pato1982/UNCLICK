      ...
      >
        ...
        <div className="overflow-y-auto px-6 py-5 text-[13px] sm:text-sm text-slate-700 leading-relaxed space-y-4 text-justify">
          ...
          <Section title="1. Introducción">
            <p>
              La presente Política de Cookies describe el uso que <strong>LocalClick S.A.</strong> (en adelante, "la
          ...
          <Section title="5. Cookies Propias y de Terceros">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li><strong>Propias:</strong> establecidas por <em>LocalClick S.A.</em> directamente.</li>
