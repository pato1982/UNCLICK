...
const MODS = [
  ...
  { id: 'MOD-002', area: 'Frontend / Nav',       prioridad: 'baja',  estado: 'hecho',   titulo: 'Clic en el logo redirige a inicio', desc: 'El logo debe navegar a la home (/).' },
  { id: 'MOD-003', area: 'Frontend / UI',        prioridad: 'baja',  estado: 'hecho',   titulo: 'Botones de sesión como texto', desc: '"Ingresar" y "Cerrar sesión" como texto, no iconos, en el header.' },
  { id: 'MOD-004', area: 'Frontend / Nav',       prioridad: 'baja',  estado: 'hecho',   titulo: 'Quitar botón "Inicio" en negocio', desc: 'Eliminar el botón amarillo "Inicio" en la vista de negocio (el logo lo reemplaza).' },
  ...
  { id: 'MOD-006', area: 'Frontend / UI',        prioridad: 'media', estado: 'hecho',   titulo: 'Nombre del negocio en modal de producto', desc: 'El modal del producto debe mostrar el nombre del negocio.' },
  ...
  { id: 'MOD-010', area: 'Frontend / UI',        prioridad: 'baja',  estado: 'hecho',   titulo: 'Quitar tabs "Tecnología" y "Tendencia"', desc: 'Eliminar esos tabs del módulo de producto.' },
  ...
  { id: 'MOD-021', area: 'Frontend / UX',        prioridad: 'baja',  estado: 'hecho',   titulo: 'Doble confirmación al cerrar sesión', desc: 'Confirmar antes del logout, en admin y en cualquier módulo.' },
  ...
  { id: 'MOD-023', area: 'Admin / Facturación',  prioridad: 'media', estado: 'hecho',   titulo: 'Módulo de facturación y plan actual', desc: 'Mostrar el plan vigente del negocio y sus características.' },
  ...
  { id: 'MOD-029', area: 'Registro / UX',        prioridad: 'media', estado: 'hecho',   titulo: 'Mensaje de éxito al registrarse', desc: 'Feedback de éxito al crear un usuario nuevo (análogo a MOD-001).' },
