...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  eliminacion_programada_at DATETIME        NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS tb_historial_seguridad (
  ...
  accion      ENUM('reset_solicitado','reset_password','cambio_password','login_fallido','login_exitoso','logout','sesion_expirada','cuenta_eliminacion_solicitada','cuenta_recuperada','cuenta_eliminada') NOT NULL,
